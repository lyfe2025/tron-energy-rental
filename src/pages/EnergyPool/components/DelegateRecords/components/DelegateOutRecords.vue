<template>
  <div class="delegate-out-records">
    <!-- 筛选器 -->
...
import { getDelegateOutTextConfig, useDelegateRecordsCommon } from '../composables/useDelegateRecordsCommon';
...
// 文本配置
const textConfig = getDelegateOutTextConfig()
