...
import { Activity, Info, Loader2, Menu, MessageSquare, X, Zap } from 'lucide-vue-next'
import { onMounted, ref, watch } from 'vue'
import type { BotData } from '../composables/useBotFormShared'
import { useBotEdit } from './EditModal/composables/useBotEdit'
import { BasicInfoTab, MenuButtonTab, MessageConfigTab, WebhookConfigTab } from './EditModal/tabs'
...
const tabs = [
  ...
  { id: 'webhook', label: '工作模式', icon: Zap },
...
const handleApplyModeChange = async () => {
  await handleModeChange(props.botData)
}
